...
class DatabaseHelper {
  ...
  List<Ingredient> parseIngredients(List<Map<String, dynamic>> ingredientList) {
    return ingredientList.map((e) => Ingredient.fromJson(e)).toList();
  }
  ...
  Stream<List<Recipe>> watchAllRecipes() async* {
    ...
    final stream = db.createQuery(recipeTable);
    final Stream<List<Recipe>> recipes_stream = 
      stream.mapToList((row) => Recipe.fromJson(row));

    yield* recipes_stream;
  }
